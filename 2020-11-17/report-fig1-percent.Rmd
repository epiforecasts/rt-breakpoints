...
In Northern Ireland there was clear evidence of a reduction in R~t~ linked with the firebreak across all data streams and methods. Among R~t~ estimated from admissions and deaths, this had a comparable effect size (between 10% to 35%, bringing R~t~ to below 1), while evidence of an effect was slightly weaker in R~t~ from cases. 

In Wales there was less evidence for an effect. There was some support for an effect in R~t~ estimated from cases (-4% to 14%, with mean of central estimates 5%), with weaker support in admissions (-9% to 8%, with mean of central estimates 1.2%). In all estimates the lower 50% credible interval of the effect size fell under 0, and there was no evidence of an effect on deaths.
